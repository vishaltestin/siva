...
export default function CollectionPage() {
  ...
  const category = categoryData?.packages.find((c) => c.id === categoryId);
    ...
    <div className="space-y-10 lg:space-y-16">
      ...
      <section className="custom-container">
        ...
        {products.length === 0 ? (
          ...
          <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-y-6 gap-x-2 md:gap-8">
            {products.map((product) => {
              ...
              return (
                <Link
                  ...
                  key={product.id}
                  className="bg-white overflow-hidden h-full flex flex-col group"
                >
                  <div className="relative h-[240px] lg:h-[500px] overflow-hidden bg-gray-100">
                    <img
                      src={
                      ...
                      loading="lazy"
                    />
                    <div className="absolute bottom-4 left-1/2 -translate-x-1/2 translate-y-20 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-300">
                      <button className="px-4 py-2 border-2 border-[#d1af5d] hover:border-white hover:bg-transparent bg-[#d1af5d] text-white text-sm font-medium transition-colors">
                        Explore
                      </button>
                    </div>
                  </div>
                  ...
                  {/* ================= PRODUCT INFO ================= */}
                  <div className="px-3 py-3 flex flex-col flex-grow items-center text-center gap-1">
