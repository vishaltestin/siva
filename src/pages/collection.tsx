...
> = {
    "rasa-luxe": {
        ...
        banner: "https://www.sivafashions.com/wp-content/uploads/2024/03/breadcrumbs-woo.jpg",
    },
    vrindas: {
        title: "Vrindas",
        description:
...
const MOCK_PRODUCTS = [
    ...
    },
    {
        ...
        title: "Designer Anarkali Suit",
        price: "₹8,499",
        image: "https://www.sivafashions.com/wp-content/uploads/2022/11/cat-04.jpg",
    },
    {
        id: 6,
        title: "Festive Lehenga Set",
    ...
    return (
        <div className="space-y-16">
            ...
            <section className="container mx-auto px-4">
                <div className="mb-10">
                    <h2 className="text-2xl font-semibold">Available Designs</h2>
